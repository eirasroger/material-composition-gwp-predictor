...
TARGET_CONFIGS: dict = {
    ...
    "fw_total": {
        ...
        "unit":          "m3/kg",
        "display_name":  "Water Depletion Total",
        "indicator_key": "fw",
        "stage_key":     "total",
    },
    "fw_a1a3": {
        ...
        "thresholds":    [0.005, 0.01, 0.05, 0.1],
        "unit":          "m3/kg",
        "display_name":  "Water Depletion A1-A3",
        "indicator_key": "fw",
        "stage_key":     "a1a3",
    },
    "fw_c3": {
        ...
        "unit":          "m3/kg",
        "display_name":  "Water Depletion C3",
        "indicator_key": "fw",
        "stage_key":     "c3",
    },
    "fw_c4": {
        ...
        "thresholds":    [2.5e-5, 5e-5, 1e-4, 5e-4],
        "unit":          "m3/kg",
        "display_name":  "Water Depletion C4",
        "indicator_key": "fw",
        "stage_key":     "c4",
    },
    "fw_d": {
        ...
        "unit":          "m3/kg",
        "display_name":  "Water Depletion D (avoided burden)",
        "indicator_key": "fw",
        "stage_key":     "d",
    },
    ...
    "ep_total": {
        ...
        "thresholds":    [5e-4, 1e-3, 5e-3, 1e-2],
        "unit":          "kg PO4-eq/kg",
        "display_name":  "Eutrophication Total",
        "indicator_key": "ep",
        "stage_key":     "total",
    },
    "ep_a1a3": {
        ...
        "thresholds":    [5e-4, 1e-3, 5e-3, 1e-2],
        "unit":          "kg PO4-eq/kg",
        "display_name":  "Eutrophication A1-A3",
        "indicator_key": "ep",
        "stage_key":     "a1a3",
    },
    "ep_c3": {
        ...
        "unit":          "kg PO4-eq/kg",
        "display_name":  "Eutrophication C3",
        "indicator_key": "ep",
        "stage_key":     "c3",
    },
    "ep_c4": {
        ...
        "thresholds":    [5e-6, 1e-5, 5e-5, 1e-4],
        "unit":          "kg PO4-eq/kg",
        "display_name":  "Eutrophication C4",
        "indicator_key": "ep",
        "stage_key":     "c4",
    },
    "ep_d": {
        ...
        "thresholds":    [2.5e-5, 5e-5, 1e-4, 5e-4],
        "unit":          "kg PO4-eq/kg",
        "display_name":  "Eutrophication D (avoided burden)",
        "indicator_key": "ep",
        "stage_key":     "d",
    },
    ...
    "ap_total": {
        ...
        "unit":          "kg SO2-eq/kg",
        "display_name":  "Acidification Total",
        "indicator_key": "ap",
        "stage_key":     "total",
    },
    "ap_a1a3": {
        ...
        "thresholds":    [2.5e-3, 5e-3, 2.5e-2, 5e-2],
        "unit":          "kg SO2-eq/kg",
        "display_name":  "Acidification A1-A3",
        "indicator_key": "ap",
        "stage_key":     "a1a3",
    },
    "ap_c3": {
    ...
    "ap_d": {
        ...
        "unit":          "kg SO2-eq/kg",
        "display_name":  "Acidification D (avoided burden)",
        "indicator_key": "ap",
        "stage_key":     "d",
    },
    ...
    "adpf_total": {
        ...
        "unit":          "MJ/kg",
        "display_name":  "Fossil Depletion Total",
        "indicator_key": "adpf",
        "stage_key":     "total",
    },
    "adpf_a1a3": {
        ...
        "thresholds":    [5.0, 10.0, 25.0, 50.0],
        "unit":          "MJ/kg",
        "display_name":  "Fossil Depletion A1-A3",
        "indicator_key": "adpf",
        "stage_key":     "a1a3",
    },
    "adpf_c3": {
        ...
        "thresholds":    [0.05, 0.1, 0.25, 0.5],
        "unit":          "MJ/kg",
        "display_name":  "Fossil Depletion C3",
        "indicator_key": "adpf",
        "stage_key":     "c3",
    },
    "adpf_c4": {
        ...
        "thresholds":    [0.05, 0.1, 0.25, 0.5],
        "unit":          "MJ/kg",
        "display_name":  "Fossil Depletion C4",
        "indicator_key": "adpf",
        "stage_key":     "c4",
    },
    "adpf_d": {
        ...
        "unit":          "MJ/kg",
        "display_name":  "Fossil Depletion D (avoided burden)",
        "indicator_key": "adpf",
        "stage_key":     "d",
    },
}
